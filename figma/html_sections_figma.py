...
# ── 이미지 경로 ──────────────────────────────────────────
_PICS   = str(Path(__file__).resolve().parent.parent / "assets")
...
IMGS = {
    ...
    # 마운팅
    "mount_cap":          str(Path(__file__).resolve().parent.parent / "assets" / "mount_cap_08.png"),
...
if __name__ == "__main__":
    ...
    out_dir = "releases/figma/wadiz/figma-sections"
