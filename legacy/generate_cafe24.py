...
from legacy.html_sections import make_section_html, screenshot_html, SECTION_LIST
from shared.runvision_brief import create_runvision_brief

OUTPUT_DIR = "releases/legacy/cafe24/sections"
CAFFE24_WIDTH = 860
